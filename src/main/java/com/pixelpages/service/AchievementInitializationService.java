...
public class AchievementInitializationService {
    ...
    private List<Achievement> createFocusAchievements() {
        return Arrays.asList(
                ...
                new Achievement("micro_master", "MICRO MASTER", "Complete 3 micro focus sessions (5-15 min)",
                        "Clock", "common", "focus", 150, "#10B981", "session_duration_range", 3),
                new Achievement("hour_apprentice", "HOUR APPRENTICE", "Spend 1 hour total in focus sessions",
                        "Clock", "common", "focus", 200, "#10B981", "total_time", 60),
                new Achievement("quick_burst", "QUICK BURST", "Complete a 5-minute focus sessions",
                        "Zap", "common", "focus", 75, "#10B981", "single_session_duration", 5),
                new Achievement("pomodoro_starter", "POMODORO STARTER", "Complete your first 25-minute in focus sessions",
                        "Target", "common", "focus", 150, "#10B981", "single_session_duration", 25),
                new Achievement("break_taker", "BREAK TAKER", "Take a 5-minute focus session break",
                        "Coffee", "common", "focus", 50, "#10B981", "break_session", 5),
                new Achievement("morning_focus", "MORNING FOCUS", "Complete a focus sessionsrind before 10 AM",
                        "Sun", "common", "focus", 100, "#10B981", "time_before", 10),
                new Achievement("category_explorer", "CATEGORY EXPLORER", "Try 2 different focus skills",
                        "Compass", "common", "focus", 100, "#10B981", "unique_categories", 2),

                // UNCOMMON TIER (10 achievements)
                new Achievement("pomodoro_warrior", "POMODORO WARRIOR", "Complete 10 Pomodoro focus sessions",
                        "Target", "uncommon", "focus", 300, "#3B82F6", "pomodoro_count", 10),
                new Achievement("focus_streak", "FOCUS STREAK", "Use focus timer for 3 days in a row",
                        "Calendar", "uncommon", "focus", 400, "#3B82F6", "daily_streak", 3),
                new Achievement("deep_diver", "DEEP DIVER", "Complete a 60+ minute focus session",
                        "Brain", "uncommon", "focus", 350, "#3B82F6", "single_session_duration", 60),
                new Achievement("dedication_keeper", "DEDICATION KEEPER", "Use focus timer for 5 hours total",
                        "Clock", "uncommon", "focus", 500, "#3B82F6", "total_time", 300),
                new Achievement("evening_scholar", "EVENING SCHOLAR", "Complete 5 focus sessions after 6 PM",
                        "Moon", "uncommon", "focus", 250, "#3B82F6", "time_after", 5),
                new Achievement("study_buddy", "STUDY BUDDY", "Complete 10 study skill focus sessions",
                        "BookOpen", "uncommon", "focus", 300, "#3B82F6", "category_sessions", 10),
                new Achievement("code_ninja", "CODE NINJA", "Complete 10 code skill focus sessions",
                        "Code", "uncommon", "focus", 300, "#3B82F6", "category_sessions", 10),
                new Achievement("work_horse", "WORK HORSE", "Complete 10 work skill focus sessions",
                        "Briefcase", "uncommon", "focus", 300, "#3B82F6", "category_sessions", 10),
                new Achievement("creative_soul", "CREATIVE SOUL", "Complete 10 creative skill focus sessions",
                        "Palette", "uncommon", "focus", 300, "#3B82F6", "category_sessions", 10),
                new Achievement("session_variety", "SESSION VARIETY", "Use focus timer in 5 different durations",
                        "Shuffle", "uncommon", "focus", 250, "#3B82F6", "duration_variety", 5),

                // RARE TIER (8 achievements)
                new Achievement("concentration_king", "CONCENTRATION KING", "Complete 50 focus sessions",
                        "Crown", "rare", "focus", 1000, "#8B5CF6", "session_count", 50),
                new Achievement("flow_state_master", "FLOW STATE MASTER", "Use focus timerfor 7 days in a row",
                        "Waves", "rare", "focus", 800, "#8B5CF6", "daily_streak", 7),
                new Achievement("marathon_mind", "MARATHON MIND", "Spend 20 hours total in focus sessions",
                        "Brain", "rare", "focus", 1200, "#8B5CF6", "total_time", 1200),
                new Achievement("category_crusher", "CATEGORY CRUSHER", "Reach 10 hours leveling up any skill",
                        "Target", "rare", "focus", 800, "#8B5CF6", "category_time", 600),
                new Achievement("deep_work_legend", "DEEP WORK LEGEND", "Complete 5 focus sessions of 90+ minutes",
