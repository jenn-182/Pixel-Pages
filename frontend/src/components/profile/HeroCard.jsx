                    ...
                    <div className="space-y-2">
                      {Object.entries(themes).map(([key, theme]) => (
                        <button
                          ...
                          className={`w-full text-left px-3 py-2 text-xs font-mono transition-colors ${currentTheme === key
              ...
              <div className="relative flex flex-col items-center justify-center gap-3">
                {currentTheme === 'pink' ? (
                  <>
                    ...
                    <HeartProgressBar
                      progress={progressPercentage}
                      maxHearts={10}  // More hearts for longer bar
                      size={65}       // Bigger hearts
                  ...
                  // Original rectangular progress bar for other themes
                  <div className="w-full h-10 relative overflow-hidden"
                    ...
                    <motion.div
                      ...
                      style={{
                        background: 'linear-gradient(90deg, #06b6d4, #22c55e, #06b6d4)',
                        borderRadius: '12px'
                      }}
                    >
